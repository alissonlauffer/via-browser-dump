...
public class MimeTypeUtils {
    ...
    /* renamed from: b */
    public static int m947b(String str) {
        if (!TextUtils.isEmpty(str)) {
            if (str.charAt(0) == '.') {
                int length = f927a.length / 2;
                for (int i = 0; i < length; i++) {
                    int i2 = i * 2;
                    if (f927a[i2].equals(str)) {
                        return i2 + 1;
                    }
                }
            }
